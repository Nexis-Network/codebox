...
module.exports = {
  ...
  'Should clear console #group1': function (browser: NightwatchBrowser) {
    browser
      ...
      .journalChildIncludes('Welcome to CodeBox')
      .click('#clearConsole')
  ...
  'Call CodeBox File Manager from a script #group2': function (browser: NightwatchBrowser) {
    browser
  ...
  'Call web3.eth.getAccounts() using CodeBox VM #group2': function (browser: NightwatchBrowser) {
    browser
  ...
  'Call CodeBox File Resolver (external URL) from a script #group3': function (browser: NightwatchBrowser) {
    browser
      .click('*[data-id="terminalClearConsole"]') // clear the terminal
  ...
  'Call CodeBox File Resolver (internal URL) from a script #group3': function (browser: NightwatchBrowser) {
    browser
      .click('*[data-id="terminalClearConsole"]') // clear the terminal
  ...
  'Call CodeBox File Resolver (internal URL) from a script and specify a path #group3': function (browser: NightwatchBrowser) {
    browser
      .click('*[data-id="terminalClearConsole"]') // clear the terminal
