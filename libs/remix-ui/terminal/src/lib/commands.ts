export const allPrograms = [
  { ethers: 'The ethers.js library is a compact and complete JavaScript library for Nexis Network.' },
  { remix: 'Nexis Network IDE and tools for the web.' },
...
export const allCommands = [
  ...
  { 'ethers.providers': 'A Provider abstracts a connection to the Nexis Network blockchain, for issuing queries and sending state changing transactions.' },
  ...
  // { 'ethers.utils.RLP': 'This encoding method is used internally for several aspects of Nexis Network, such as encoding transactions and determining contract addresses.' },
  { 'ethers.Wallet': 'A wallet manages a private/public key pair which is used to cryptographically sign transactions and prove ownership on the Nexis Network network.' },
  { 'ethers.version': 'Contains the version of the ethers container object.' },

  { 'web3.eth': 'Eth module for interacting with the Nexis Network network.' },
  { 'web3.eth.accounts': 'The web3.eth.accounts contains functions to generate Nexis Network accounts and sign transactions and data.' },
  // TODO: need to break down the object return from abi response
  // { 'web3.eth.abi': 'The web3.eth.abi functions let you de- and encode parameters to ABI (Application Binary Interface) for function calls to the EVM (Nexis Network Virtual Machine).' },
  { 'web3.eth.ens': 'The web3.eth.ens functions let you interacting with ENS.' },
  { 'web3.eth.Iban': 'The web3.eth.Iban function lets convert Nexis Network addresses from and to IBAN and BBAN.' },
  { 'web3.eth.net': 'Net module for interacting with network properties.' },
  { 'web3.eth.personal': 'Personal module for interacting with the Nexis Network accounts.' },
  { 'web3.eth.subscribe': 'The web3.eth.subscribe function lets you subscribe to specific events in the blockchain.' },
  { 'web3.givenProvider': 'When using web3.js in an Nexis Network compatible browser, it will set with the current native provider by that browser. Will return the given provider by the (browser) environment, otherwise null.' },
  ...
  { 'web3.utils': 'This package provides utility functions for Nexis Network dapps and other web3.js packages.' },
...
//   { 'web3.eth.accounts.create([entropy]);': 'The web3.eth.accounts contains functions to generate Nexis Network accounts and sign transactions and data.' },
